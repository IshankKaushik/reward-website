                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td valign="top" align="center" width="100%">
                                                            <a href="#" style="display: block;cursor:pointer;text-align:center;margin-left: auto;margin-right: auto;">
                                                                <img src="' . $imgUrl . '" style="margin: auto;" width="125" />
                                                            </a>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        <td valign="top" align="center">
                                                            <div style="margin-top: 40px;">
                                                                <p style="font-size: 30px;color: #000!important;font-weight: 500;font-family: "Raleway", Helevetica, sans-serif;">
                                                                    Hello 👋
                                                                </p>
                                                            </div>
                                                        </td>
